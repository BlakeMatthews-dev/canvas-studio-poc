...
export default function App() {
  ...
  if (view === "loading") {
    return (
      <div className="app-shell">
        <div className="topbar"><a href="/" className="logo" style={{ textDecoration: "none" }}>MAIN CHARACTER CREW</a><div className="spacer" /></div>
  ...
  if (view === "landing" && !bookSpec) {
    return (
      <div className="app-shell">
        <div className="topbar"><a href="/" className="logo" style={{ textDecoration: "none" }}>MAIN CHARACTER CREW</a><div className="spacer" /><button onClick={startNew}>New Book</button></div>
    ...
    return (
      <div className="app-shell">
        <div className="topbar">
          <a href="/" className="logo" style={{ textDecoration: "none" }}>MAIN CHARACTER CREW</a>
